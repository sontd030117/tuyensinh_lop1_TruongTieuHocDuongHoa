    ...
    if rows:
        ...
        with col_ch2:
            ...
            if "student_gender" in df.columns and len(df) > 0:
                ...
                st.info("Chưa có dữ liệu cơ cấu giới tính.")
        st.write("---")
