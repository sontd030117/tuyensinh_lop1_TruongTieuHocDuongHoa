    ...
    if rows:
        ...
        if len(student_list) > 0:
            ...
            if not matched_data.empty:
                ...
                # ĐÃ SỬA TRIỆT ĐỂ LỖI IN: Làm sạch cú pháp hàm JavaScript window.open dồn chuỗi liên tục tuyệt đối
